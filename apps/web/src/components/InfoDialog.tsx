      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex items-baseline gap-3">
            <span
              className="animate-blink font-mono text-base text-[var(--color-accent)]"
              aria-hidden="true"
            >
              ▸
            </span>
            <h2
              className="font-mono text-3xl font-bold tracking-[0.22em] text-[var(--color-accent)]"
              style={{ textShadow: "0 0 28px rgba(232,80,32,0.3)" }}
            >
              PAVOIA
            </h2>
          </div>
          <p className="mt-2 pl-7 font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--color-text-faint)]">
            // gaende's webradio · v3
          </p>
        </div>

        <div className="border-l-2 border-[var(--color-accent)] pl-4 font-serif text-base italic leading-relaxed text-[var(--color-text-soft)]">
        ...
        <div className="rounded-sm border border-[var(--color-card-border)] bg-[var(--color-bg-soft)] px-4 py-3">
